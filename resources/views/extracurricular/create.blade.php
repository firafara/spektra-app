...
@section('content')
    ...
    <h1 class="page-header"><small><b>Create Extracurricular</b></small></h1>
    <div class="row">
        <div class="col-xl-12 ui-sortable">
            <form action="{{ route('extracurricular/store') }}" method="POST" id="main_form" enctype="multipart/form-data">
                @csrf
                <div class="panel panel-inverse">
                    <div class="panel-heading ui-sortable-handle">
                        <h4 class="panel-title">Extracurricular Create</h4>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="name" class="form-control form-control-sm m-b-5" placeholder="Enter Name"
                                        name="name" />
