...
@section('content')
    ...
    <h1 class="page-header"><small><b>List Teacher</b></small></h1>
    <div class="row">
        <div class="col-xl-12">
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    ...
                    <div class="panel-heading-btn">
                        ...
                        <a href="{{ route('teacher/create') }}" class="btn btn-xs btn-icon btn-circle btn-green"
