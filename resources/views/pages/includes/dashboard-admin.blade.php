                        ...
                        <table class="table table-hover table-bordered">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ auth()->user()->student->class->grade ?? 'Grade Not available' }} {{ auth()->user()->student->class->major_name ?? 'Major Not available' }} {{ auth()->user()->student->class->class_name ?? 'Class Not available' }}</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td><b>Birthdate</b></td>
                                    <td>{{ date('d-M-y', strtotime(auth()->user()->student->birthdate ?? 'Not available')) }}</td>
                                </tr>
                                <tr>
                        ...
                        <table class="table table-striped center">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if(auth()->user()->role == 'Student' && auth()->user()->registration)
                                           You Have {{ auth()->user()->registration->where('status', 'Pending')->count() }} Pending Status
                                        @else
                                            Not available
                                        @endif
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if(auth()->user()->role == 'Student' && auth()->user()->registration)
                                           You Have {{ auth()->user()->registration->where('status', 'Approved')->count() }} Approved Status
                                        @else
                                            Not available
                                        @endif
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if(auth()->user()->role == 'Student' && auth()->user()->registration)
                                           You Have {{ auth()->user()->registration->where('status', 'Rejected')->count() }} Rejected Status
                                        @else
                                            Not available
                                        @endif
                                    </td>
