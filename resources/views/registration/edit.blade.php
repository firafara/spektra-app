...
@section('content')
    ...
    <h1 class="page-header"><small><b>Edit Registration</b></small></h1>
    <div class="row">
        <div class="col-xl-12 ui-sortable">
            <form action="{{ route('registration/update', $data->registration_id) }}}" method="POST" id="main_form">
                @csrf
                @method('post')
                <div class="panel panel-inverse">
                    <div class="panel-heading ui-sortable-handle">
                        <h4 class="panel-title">Registration Edit</h4>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="extracurricular_id" id="extracurricular_id" class="form-control form-control-sm col-md-12 {{ $errors->has('extracurricular_id') ? 'is-invalid' : '' }}">
                                        ...
                                        @foreach ($extracurricular as $extracurriculars)
                                            <option value="{{ $extracurriculars->extracurricular_id }}" {{ old('extracurricular_id', $data->extracurricular_id) == $extracurriculars->extracurricular_id ? 'selected' : '' }}>
                                    ...
                                    <div class="col-sm-13">
                                        <div class="input-group date" id="registration_date-input">
                                            <input type="text" class="form-control form-control-sm" id="registration_date"
                                                name="registration_date" value="{{ old('registration_date', $data->registration_date) }}" />
