...
@section('title', 'Achievement Edit')
@push('css')
...
@section('content')
    ...
    <h1 class="page-header"><small><b>Edit Achievement</b></small></h1>
    <div class="row">
        <div class="col-xl-12 ui-sortable">
            <form action="{{ route('achievement/update', $data->achievement_id) }}" method="POST" id="main_form" enctype="multipart/form-data">
                @csrf
                <div class="panel panel-inverse">
                    <div class="panel-heading ui-sortable-handle">
                        <h4 class="panel-title">Achievement Edit</h4>
